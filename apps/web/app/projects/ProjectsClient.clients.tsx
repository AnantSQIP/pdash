 ...
 * is ProjectsClient.tsx, which dispatches to this one when the organisation runs CLIENTS.
 */
...
import { ClientsProjectCard as ProjectCard, ProjectListRow } from '@/components/projects/ProjectCard.clients';
 ...
 */
export function ClientsProjectsClient() {
