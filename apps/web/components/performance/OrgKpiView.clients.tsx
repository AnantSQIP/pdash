 ...
 * is OrgKpiView.tsx, which dispatches to this one when the organisation runs CLIENTS.
 */
/**
...
import { KpiHero, Breaches, Stat, ExcludedNote, KpiGlossary, CLIENTS_KPI_HELP as KPI_HELP, kpiDonuts, overrunColor } from './KpiCards';
import { ClientsUserKpiPanel as UserKpiPanel } from './UserKpiPanel.clients';
...
export function ClientsOrgKpiView({ period }: { period: PeriodWindow }) {
