 ...
 * is UserKpiPanel.tsx, which dispatches to this one when the organisation runs CLIENTS.
 */
/**
...
import { KpiHero, Breaches, Stat, ExcludedNote, KpiGlossary, CLIENTS_KPI_HELP as KPI_HELP, kpiDonuts, streakCaption, overrunColor } from './KpiCards';
...
export function ClientsUserKpiPanel({ userId, period, self = false }: {
  userId: string;
  period: PeriodWindow;
