...
import { ClientsPunchOutGate } from './PunchOutGate.clients';

/** PROJECTS flow: files what the clock recorded today, or sends the person to Timesheets. */
function ProjectsPunchOutGate({ check, onClose, onReady, onLeaveAnyway }: {
  check: PunchOutCheck;
  onClose: () => void;
...
/** One component, two flows: production's (above) for PROJECTS, ./PunchOutGate.clients.tsx for CLIENTS. */
export const PunchOutGate = byFlow(ProjectsPunchOutGate, ClientsPunchOutGate);
