...
/** CLIENTS flow: Log time opens the day sheet on today, and a full day lets the person out. */
export function ClientsPunchOutGate({ check, onClose, onReady, onLeaveAnyway }: {
  check: PunchOutCheck;
  onClose: () => void;
