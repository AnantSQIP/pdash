...
import { ClientsCatchUpBanner } from './CatchUpBanner.clients';

/** PROJECTS flow: running clocks, auto-closed days and short days — filed from the clock when it has the hours. */
function ProjectsCatchUpBanner() {
...
/** One component, two flows: production's (above) for PROJECTS, ./CatchUpBanner.clients.tsx for CLIENTS. */
export const CatchUpBanner = byFlow(ProjectsCatchUpBanner, ClientsCatchUpBanner);
