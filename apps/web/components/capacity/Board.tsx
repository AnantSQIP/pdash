...
export function Board({
  ...
  aggregateOthers, onSelectPerson, onAssign, emptyText, fill, hoverSuppressed,
}: {
  ...
  /**
   * Inside one project's view: every other project's hours collapse into a single neutral block
   * in each cell instead of being drawn per task and faded out. A day full of somebody else's work
  ...
  // What the CELLS draw. Identical to the above on the full board; inside one project's view every
  ...
  //
  // Only while THIS project is the one pinned: pinning some other matter from the legend is a
            ...
            {flat.length === 0 ? (
              ...
              <div key={g.key}>
                ...
                {g.rows.map(row => {
                  ...
                  // This project's share of the window comes from the API's availability service
