...
const TYPE_META: Record<string, { Icon: typeof RiNotification3Line; color: string; bg: string }> = {
  ...
  'project.cid_moved': { Icon: RiRefreshLine,        color: 'text-amber-600', bg: 'bg-amber-50' },
  ...
  'expense.rejected':  { Icon: RiCloseCircleLine,       color: 'text-red-600',    bg: 'bg-red-50' },
  'expense.reimbursed':{ Icon: RiMoneyDollarCircleLine, color: 'text-brand-600',  bg: 'bg-brand-50' },
