...
import { ClientsLogTimeStandaloneModal } from './LogTimeStandaloneModal.clients';
...
/** PROJECTS flow: log time against a project task (PID, or 'Assign PID later'), a client call, or other time; billable is the person's choice. */
function ProjectsLogTimeStandaloneModal({ onClose, onSuccess, defaultDate }: { onClose: () => void; onSuccess: () => void; defaultDate?: string }) {
...
/** One component, two flows: the PROJECTS implementation above (production's), ./LogTimeStandaloneModal.clients.tsx for CLIENTS. */
export const LogTimeStandaloneModal = byFlow(ProjectsLogTimeStandaloneModal, ClientsLogTimeStandaloneModal);
