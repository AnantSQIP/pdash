...
import { ClientsTaskListView, ClientsOverviewView } from './views.clients';
...
function ProjectsOverviewView({ project, tasks }: { project: ApiProject; tasks: ApiTask[] }) {
...
// The PROJECTS implementation above is production's (bb5728b); CLIENTS is views.clients.tsx.
export const TaskListView = byFlow(ProjectsTaskListView, ClientsTaskListView);
export const OverviewView = byFlow(ProjectsOverviewView, ClientsOverviewView);
