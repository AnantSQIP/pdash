...
import { ClientsTaskGroups } from './TaskGroups.clients';
 ...
 */
function ProjectsTaskGroups({ projectId, tasks, loading, statuses, canEdit, onTaskClick, onAddTask, onStatusChange }: {
  projectId: string;
  tasks: ApiTask[];
  loading: boolean;
...
// The PROJECTS implementation above is production's (bb5728b); CLIENTS is TaskGroups.clients.tsx.
export const TaskGroups = byFlow(ProjectsTaskGroups, ClientsTaskGroups);
