...
import ClientsActivityTab from './ActivityTab.clients';
...
function ProjectsActivityTab({ projectId }: { projectId: string }) {
...
// The PROJECTS implementation above is production's (bb5728b); CLIENTS is ActivityTab.clients.tsx.
export default byFlow(ProjectsActivityTab, ClientsActivityTab);
