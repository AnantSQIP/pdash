...
import { ClientsProjectCard } from './ProjectCard.clients';
...
function ProjectsProjectCard({ project }: ProjectCardProps) {
...
// The PROJECTS implementation above is production's (bb5728b); CLIENTS is ProjectCard.clients.tsx.
export const ProjectCard = byFlow(ProjectsProjectCard, ClientsProjectCard);
