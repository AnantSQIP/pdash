...
import { ClientsEditProjectModal } from './EditProjectModal.clients';
 ...
 */
function ProjectsEditProjectModal({ project, onClose, onSaved }: {
  project: ApiProject;
  onClose: () => void;
...
// The PROJECTS implementation above is production's (bb5728b); CLIENTS is EditProjectModal.clients.tsx.
export const EditProjectModal = byFlow(ProjectsEditProjectModal, ClientsEditProjectModal);
