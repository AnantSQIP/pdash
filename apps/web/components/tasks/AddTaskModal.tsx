...
export function AddTaskModal({ projectId, taskListId, onClose, onCreated }: AddTaskModalProps) {
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition"
            />
            <p className="text-xs text-gray-400 mt-1">Comma-separated emails — real picker coming soon</p>
          </div>
