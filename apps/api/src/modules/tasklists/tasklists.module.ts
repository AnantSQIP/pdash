import { Body, Controller, Delete, ForbiddenException, Get, Injectable, Module, Param, Patch, Post, Query } from '@nestjs/common';
...
/**
 * CLIENTS-FLOW: task groups across every client the reader may see.
 *
...
class TaskGroupSearchController {
  ...
  async search(
    ...
    return this.service.search(await this.actor.requireOrgId(), {
